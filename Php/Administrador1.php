    ...
    <div class="baul_header">
        ...
        <div class="panel_button">
            <a href="Administrador.php">
                <input class="input" type="button" value="Semana">
            </a>
            <a href="../index.php">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <th><a href="actualizar1.php?id=<?php echo $row['Titulo'] ?>" >Modificar</a></th>
                        <th><a href="delete1.php?id=<?php echo $row['Titulo'] ?>" >Eliminar</a></th>                                          
                    </tr>
                <?php 
                    }
                ?>
